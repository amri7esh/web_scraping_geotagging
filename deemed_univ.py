...
def get_state_university_data(state_id):
    URL = "https://www.ugc.ac.in/deemeduniversitylist.aspx?id={}&Unitype=4".format(state_id)
    page = requests.get(URL)
