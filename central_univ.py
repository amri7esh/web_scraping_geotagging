...
def get_state_university_data(state_id):
    URL = "https://www.ugc.ac.in/centralniversitylist.aspx?id={}&Unitype=1".format(state_id)
    page = requests.get(URL)
    ...
    for tr in soup.findAll('tr'):
        ...
        univ_data['university_id'] = urls[0].get('src')[urls[0].get('src').find("=")+1:]
